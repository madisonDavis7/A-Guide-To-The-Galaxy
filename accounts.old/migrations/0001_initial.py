    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_question', models.IntegerField(choices=[(0, 'What was the name of your first pet?'), (1, 'What street did you grow up on?'), (2, "What is your mother's maiden name?"), (3, 'Where was your first date?'), (4, 'How many fingers am I holding up?')], max_length=2, null=True)),
